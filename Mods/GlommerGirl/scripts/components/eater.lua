local Eater = Class(function(self, inst)
    ...
    self.ablefoods = { "MEAT", "VEGGIE", "INSECT", "SEEDS", "GENERIC", "GIRLPOOP" }
    self:SetOmnivore()
    self.oneatfn = nil
...
function Eater:SetElemental(human)
    ...
    if human then
        self.ablefoods = { "MEAT", "VEGGIE", "INSECT", "SEEDS", "GENERIC", "ELEMENTAL", "GIRLPOOP" }
    else
...
function Eater:SetOmnivore()
    self.foodprefs = { "MEAT", "VEGGIE", "INSECT", "SEEDS", "GENERIC", "GIRLPOOP" }
    self.ablefoods = { "MEAT", "VEGGIE", "INSECT", "SEEDS", "GENERIC", "GIRLPOOP" }
end
