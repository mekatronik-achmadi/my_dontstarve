...
return {
	ACTIONFAIL =
	{
		SHAVE =
		{
			AWAKEBEEFALO = "Maybe not now.. hehe...",
			GENERIC = "Nope",
			NOBITS = ":(!",
		},
		STORE =
	...
	ANNOUNCE_ADVENTUREFAIL = "Ups. I'll have to try again hehe...",
	...
	ANNOUNCE_ENTER_LIGHT = "Light On!",
	ANNOUNCE_FREEDOM = "I'm free! I'm finally free!",
	ANNOUNCE_HIGHRESEARCH = "I feel so smart now!",
	ANNOUNCE_HOUNDS = "What was that?...",
	ANNOUNCE_HUNGRY = "I NEED BREAD!!!",
	ANNOUNCE_HUNT_BEAST_NEARBY = "It's near...",
	...
	ANNOUNCE_NODANGERSLEEP = "Maybe not...",
	ANNOUNCE_NODAYSLEEP = "I can't... the sun...",
	ANNOUNCE_NODAYSLEEP_CAVE = "I'm not tired at all...",
	ANNOUNCE_NOHUNGERSLEEP = "I can't sleep without eating first!",
	...
	BATTLECRY =
	{
		...
		PREY = "Faito Dayo!",
		SPIDER = "If you mess with the bull you get the Honk.!",
		SPIDER_WARRIOR = "Gyaaaaah!!!",
	},
	COMBAT_QUIT =
	{
		GENERIC = "Don't mess with the Honk!",
		PIG = "If you mess with the bull you get the Honk.",
		PREY = "He's too fast!",
		SPIDER = "Whatever.",
	...
	DESCRIBE =
	{
		...
		EEL_COOKED = "Smells like mom's food!",
